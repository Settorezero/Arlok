...
#include <VL53L0X.h> // VL53L0X by Pololu - tested 1.3.1
...
#define OBSTACLE    150           // ARLOK will stop if an obstacle is nearer than this (mm)
...
// Global variables
volatile long distance = 0;        // distance measured by laser, cm
...
void setup(void) 
 ...
 // if P1 is pressed during the setup function, I'll start the setup mode
  ...
  // sensor1.setMeasurementTimingBudget(200000); // high accuracy 
