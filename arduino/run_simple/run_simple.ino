...
// CHECK THOSE VALUES IF YOU'VE PROBLEMS!
#define SPEED 400                 // normal speed for forward moving (center point+speed microseconds), rise this if your robot doesn't move
#define SPEED_SLOW 125            // speed used for maneuvers, raise this if your robot cannot turn
#define TURN_TIME 1400            // amount of time used for turning, change this if turning angle is not 90 degrees
...
void dritto(uint16_t vel) {
  ...
  MotorL.write(servoL_balanced + vel);
  MotorR.write(servoR_balanced - vel);
}
